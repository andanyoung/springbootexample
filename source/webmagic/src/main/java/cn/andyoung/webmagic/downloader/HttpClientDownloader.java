package cn.andyoung.webmagic.downloader;
...
public class HttpClientDownloader extends us.codecraft.webmagic.downloader.HttpClientDownloader {
  ...
  private us.codecraft.webmagic.downloader.HttpClientGenerator httpClientGenerator =
      new cn.andyoung.webmagic.downloader.HttpClientGenerator();
  ...
  protected Page handleResponse(
      Request request, String charset, HttpResponse httpResponse, Task task) throws IOException {
